...
<head>
    ...
    <title>Coverage for /home/debrsa01/Desktop/Data_Sense/data_sense/lib/python3.7/site-packages/pymongo/monotonic.py: 86%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>/home/debrsa01/Desktop/Data_Sense/data_sense/lib/python3.7/site-packages/pymongo/monotonic.py</b> :
...
<p id="t20" class="stm run hide_run"><span class="nam">__all__</span> <span class="op">=</span> <span class="op">[</span><span class="str">'time'</span><span class="op">]</span><span class="strut">&nbsp;</span></p>
...
<p id="t23" class="pln">    <span class="com"># Patches standard time module.</span><span class="strut">&nbsp;</span></p>
<p id="t24" class="pln">    <span class="com"># From https://pypi.python.org/pypi/Monotime.</span><span class="strut">&nbsp;</span></p>
<p id="t25" class="stm run hide_run">    <span class="key">import</span> <span class="nam">monotime</span><span class="strut">&nbsp;</span></p>
...
<p id="t30" class="pln">    <span class="com"># From https://pypi.python.org/pypi/monotonic.</span><span class="strut">&nbsp;</span></p>
<p id="t31" class="stm run hide_run">    <span class="key">from</span> <span class="nam">monotonic</span> <span class="key">import</span> <span class="nam">monotonic</span> <span class="key">as</span> <span class="nam">time</span><span class="strut">&nbsp;</span></p>
...
<p id="t34" class="pln">        <span class="com"># Monotime or Python 3.</span><span class="strut">&nbsp;</span></p>
<p id="t35" class="stm run hide_run">        <span class="key">from</span> <span class="nam">time</span> <span class="key">import</span> <span class="nam">monotonic</span> <span class="key">as</span> <span class="nam">time</span><span class="strut">&nbsp;</span></p>
...
<p id="t37" class="pln">        <span class="com"># Not monotonic.</span><span class="strut">&nbsp;</span></p>
<p id="t38" class="stm mis">        <span class="key">from</span> <span class="nam">time</span> <span class="key">import</span> <span class="nam">time</span><span class="strut">&nbsp;</span></p>
